...
export const EMPLOYEE_COUNT_RANGES = ["MICRO", "SMALL", "MEDIUM", "LARGE"] as const;
...
export const CONTACT_TYPES = ["PRIMARY", "SECONDARY", "FINANCE", "TECHNICAL"] as const;
...
export const PHONE_COUNTRY_PREFIXES: readonly PhoneCountryPrefix[] = [
