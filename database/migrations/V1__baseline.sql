...
-- -------------------------
-- Admin seed users (password = bcrypt of 'Admin@1234')
-- -------------------------

INSERT INTO users (id, email, password_hash, role, is_active, email_verified) VALUES
    (gen_random_uuid(), 'superadmin@supplierplatform.com',   '$2b$12$hA8/MvrZ35gW3V4KXK/BHe0G7yVkDfgPFNM1vjdlkaEm2Trp5qs4W', 'ADMIN', TRUE, TRUE),
    (gen_random_uuid(), 'responsabile@supplierplatform.com', '$2b$12$hA8/MvrZ35gW3V4KXK/BHe0G7yVkDfgPFNM1vjdlkaEm2Trp5qs4W', 'ADMIN', TRUE, TRUE),
    (gen_random_uuid(), 'revisore@supplierplatform.com',     '$2b$12$hA8/MvrZ35gW3V4KXK/BHe0G7yVkDfgPFNM1vjdlkaEm2Trp5qs4W', 'ADMIN', TRUE, TRUE),
...
SELECT
    ...
    u.id,
    r.admin_role,
    (SELECT id FROM users WHERE email = 'superadmin@supplierplatform.com')
FROM (VALUES
    ('superadmin@supplierplatform.com',   'SUPER_ADMIN'      ),
    ('responsabile@supplierplatform.com', 'RESPONSABILE_ALBO'),
    ('revisore@supplierplatform.com',     'REVISORE'         ),
