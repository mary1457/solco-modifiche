...
public class SubmitEvaluationRequest {
    ...
    public String getCollaborationPeriod() { return collaborationPeriod; }
    public void setCollaborationPeriod(String collaborationPeriod) { this.collaborationPeriod = collaborationPeriod; }
    ...
    public Map<String, Short> getDimensions() { return dimensions; }
    public void setDimensions(Map<String, Short> dimensions) { this.dimensions = dimensions; }
}
